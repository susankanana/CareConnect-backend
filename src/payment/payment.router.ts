...
const payment = (app: Express) => {
  ...
  app.route('/payment/mpesa/initiate').post(userRoleAuth, async (req, res, next) => {
    try {
  ...
  app.route('/payment/mpesa/callback/:appointmentId').post(async (req, res, next) => {
    try {
  ...
  app.route('/payment/checkout-session').post(userRoleAuth, async (req, res, next) => {
    try {
  ...
  app.route('/payments').get(allRoleAuth, async (req, res, next) => {
    try {
  ...
  app.route('/payment/:id').get(allRoleAuth, async (req, res, next) => {
    try {
  ...
  app.route('/payments/appointment/:appointmentId').get(userRoleAuth, async (req, res, next) => {
    try {
  ...
  app.route('/payments/status/:appointmentId').get(userRoleAuth, async (req, res, next) => {
    try {
