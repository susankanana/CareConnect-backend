...
import { adminRoleAuth, userRoleAuth, allRoleAuth } from '../middleware/bearerAuth';

const complaint = (app: Express) => {
  // Create complaint (user only)
  app.route('/complaint/register').post(userRoleAuth, async (req, res, next) => {
    try {
  ...
  app.route('/complaints').get(adminRoleAuth, async (req, res, next) => {
    try {
  ...
  app.route('/complaint/:id').get(allRoleAuth, async (req, res, next) => {
    try {
  ...
  app.route('/complaints/user/:userId').get(userRoleAuth, async (req, res, next) => {
    try {
  ...
  app.route('/complaints/status/:status').get(adminRoleAuth, async (req, res, next) => {
    try {
  ...
  app.route('/complaint/:id').put(adminRoleAuth, async (req, res, next) => {
    try {
  ...
  app.route('/complaint/status/:id').patch(adminRoleAuth, async (req, res, next) => {
    try {
  ...
  app.route('/complaint/:id').delete(adminRoleAuth, async (req, res, next) => {
    try {
