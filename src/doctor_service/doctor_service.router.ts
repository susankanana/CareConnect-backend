...
const doctorServiceRoutes = (app: Express) => {
  ...
  app.route('/doctor-services/assign').post(bothRoleAuth, async (req, res, next) => {
    try {
  ...
  app.route('/doctor-services/doctor/:doctorId').get(async (req, res, next) => {
    try {
  ...
  app.route('/doctor-services/service/:serviceId').get(async (req, res, next) => {
    try {
