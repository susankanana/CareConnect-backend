...
const service = (app: Express) => {
  ...
  app.route('/service/register').post(bothRoleAuth, async (req, res, next) => {
    try {
  ...
  app.route('/services').get(async (req, res, next) => {
    try {
  ...
  app.route('/service/:title').get(async (req, res, next) => {
    try {
  ...
  app.route('/service/:id').get(adminRoleAuth, async (req, res, next) => {
    try {
  ...
  app.route('/service/:id').put(bothRoleAuth, async (req, res, next) => {
    try {
  ...
  app.route('/service/:id').delete(bothRoleAuth, async (req, res, next) => {
    try {
