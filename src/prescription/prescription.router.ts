...
const prescription = (app: Express) => {
  ...
  app.route('/prescription/register').post(bothRoleAuth, async (req, res, next) => {
    try {
  ...
  app.route('/prescriptions').get(adminRoleAuth, async (req, res, next) => {
    try {
  ...
  app.route('/prescription/:id').get(adminRoleAuth, async (req, res, next) => {
    try {
  ...
  app.route('/prescriptions/patient/:patientId').get(userRoleAuth, async (req, res, next) => {
    try {
  ...
  app.route('/prescriptions/doctor/:doctorId').get(bothRoleAuth, async (req, res, next) => {
    try {
  ...
  app.route('/prescription/:id').put(bothRoleAuth, async (req, res, next) => {
    try {
  ...
  app.route('/prescription/:id').delete(bothRoleAuth, async (req, res, next) => {
    try {
