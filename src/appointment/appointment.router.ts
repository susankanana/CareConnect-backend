...
const appointment = (app: Express) => {
  ...
  app.route('/appointment/register').post(userRoleAuth, async (req, res, next) => {
    try {
  ...
  app.route('/appointments').get(adminRoleAuth, async (req, res, next) => {
    try {
  ...
  app.route('/appointments/detailed').get(adminRoleAuth, async (req, res, next) => {
    try {
  ...
  app.route('/appointment/:id').get(bothRoleAuth, async (req, res, next) => {
    try {
  ...
  app.route('/appointments/user/:userId').get(userRoleAuth, async (req, res, next) => {
    try {
  ...
  app.route('/appointments/doctor/:doctorId').get(doctorRoleAuth, async (req, res, next) => {
    try {
  ...
  app.route('/appointments/status/:status').get(adminRoleAuth, async (req, res, next) => {
    try {
  ...
  app.route('/appointment/:id').put(bothRoleAuth, async (req, res, next) => {
    try {
  ...
  app.route('/appointment/status/:id').patch(bothRoleAuth, async (req, res, next) => {
    try {
